...
|--------------------------------------------------------------------------
| Includes Important settings to init a Search code API.
|
*/

/* Repositories Search URL without ? */
$config['search_code_url'] = 'https://api.github.com/search/code';

/* Authorization token */
$config['token']='0202fc41e4f7da0e6288675b529ff38313f02f51';
...
/* Sort Parameter */
$config['sort'] = 'sort';
$config['sort_default'] = ''; //by default for GitHub it sorts by score (best matches) Order by DESC

/* Order Parameter */
$config['order'] = 'order';
$config['order_default'] = 'desc';//by default for GitHub it sorts by score (best matches) Order by DESC
...
/* items field */
$config['items'] = 'items'; //Leave it empty if its direct or you can specify tree.. ie data.items
